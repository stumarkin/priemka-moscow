		...
		<div class="container" id="app">
          ...
          <div class="row">
            <div class="col px-4 pt-4 pb-2">
              <div class="h2" style="font-weight: 700;">Что это?</div>
              <p>Это приложение для самостоятельной приёмки квартиры в новостройке. Оно позволит вам провести приёмку без привлечения специалиста.</p>
            </div>
          </div>
          <div class="row">
              <div class="col px-3">
                  <div class="p-4 rounded-3 }" style="background-color: #ffde84;">
                    <h2 class="text-dark">5 000₽</h2>
                    <p >Столько примерно вы сэкономите, не заказывая приёмку квартиры у сторонних специалистов. С&nbsp;этим приложением вы можете сделать ее бесплатно. Наверняка, у вас найдется лучшее применение этим деньгам. Ведь&nbsp;переезд в&nbsp;новую квартиру — это всегда хлопотное и&nbsp;затратное дело.</p>
                  </div>
              </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col px-4">
              ...
              <ul>
                ...
                <li>в виде <u>списка недостатков</u>; его нужно отправить менеджеру застройщика, чтобы он включил его в акт приёмки</li>
              </ul>
          ...
          <div class="row">
            <div class="col p-4">
                  <div class="h4 mt-2" style="font-weight: 700;">Ограничения</div>
                  <p>Это приложение содержит ограничения бесплатного использования:</p>
                  <ul>
                    <li>в списке недостатков не указываются ссылки на нормативные акты, СНиП и ГОСТ</li>
                    <li>можно провести не более 5 приёмок</li>
                    <li>внесение изменений в каждую приёмку не доступно спустя сутки после ее начала</li>
                  </ul>
                  <p>Pro-тариф снимает все указанные ограничения.</p>
